...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<example.HelloRequest,
      example.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = example.HelloRequest.class,
      responseType = example.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<example.HelloRequest,
      example.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<example.HelloRequest, example.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<example.HelloRequest, example.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  example.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  example.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(example.HelloRequest request,
        io.grpc.stub.StreamObserver<example.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void sayHello(example.HelloRequest request,
        io.grpc.stub.StreamObserver<example.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub
    ...
    /**
     */
    public example.HelloReply sayHello(example.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<example.HelloReply> sayHello(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((example.HelloRequest) request,
              (io.grpc.stub.StreamObserver<example.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return example.HelloWorldProto.getDescriptor();
    }
